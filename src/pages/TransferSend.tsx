    ...
    return (
        ...
        <div className="space-y-12">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 border-b border-gray-900/10 pb-12 md:grid-cols-3">
                ...
                <div>
                    <h2 className="text-base/7 font-semibold text-gray-900">Send</h2>
                    <p className="mt-1 text-sm/6 text-gray-600">
                      Instantly transfer funds to another wallet in the same network.
                    </p>
                </div>
                ...
                <div className="grid max-w-2xl grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6 md:col-span-2">
                    ...
                    <div className="sm:col-span-4">
                        <label htmlFor="to" className="block text-sm/6 font-medium text-gray-900">
                            Wallet:
                        </label>
                        <div className="mt-2">
                            <div className="flex items-center rounded-md bg-white pl-3 outline-1 -outline-offset-1 outline-gray-300 focus-within:outline-2 focus-within:-outline-offset-2 focus-within:outline-indigo-600">
                                <input
                                    ...
                                    name="to"
                                    value={to}
                                    placeholder="44FpkJSQUPYJjSYLKgg1qrt5PZAR9VRYFoaTJNbRXkCd"
        ...
        <div className="mt-6 flex items-center justify-end gap-x-6">
            {
                signature ? <span className='text-md text-green-600'>Success!</span> :
                <button
                  type="submit"
