        ...
        <div className="border-t border-gray-100 dark:border-white/5">
          <dl className="divide-y divide-gray-100 dark:divide-white/5">
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              <dt className="text-sm font-medium text-gray-900 dark:text-gray-100">Organization</dt>
              <dd className="mt-1 text-sm/6 text-gray-700 sm:col-span-2 sm:mt-0 dark:text-gray-300">{organization ? organization.name : null}</dd>
            </div>
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              <dt className="text-sm font-medium text-gray-900 dark:text-gray-100">Wallet</dt>
              <dd className="mt-1 truncate text-sm/6 text-gray-700 sm:col-span-1 sm:mt-0 dark:text-gray-300">{organization ? organization.wallet : null}</dd>
            ...
            <div className="px-4 py-6 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
              <dt className="text-sm font-medium text-gray-900 dark:text-gray-100">API Keys</dt>
              <dd className="mt-1 italic text-sm/6 text-gray-500 sm:col-span-1 sm:mt-0 dark:text-gray-300">Create & manage API keys</dd>
              <div className='sm:col-span-1 flex flex-row justify-end'>
                <button
