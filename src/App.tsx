  ...
  return (
    <div>
      <Routes>
        ...
        <Route path="/overview/:mintId" element={<Locked><UI><Mint/></UI></Locked>}/>
        <Route path="/sales/:mintId" element={<Locked><UI><Sales/></UI></Locked>}/>
        <Route path="/developer/:mintId" element={<Locked><UI><MintKeys/></UI></Locked>}/>
